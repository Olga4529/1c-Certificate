...
Функция ПолучитьМассивБаркодов()
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		НоваяЗапись = Новый Структура("sku, amount");
			НоваяЗапись.sku = Число(ВыборкаДетальныеЗаписи.Значение); 
			НоваяЗапись.amount = Число(ВыборкаДетальныеЗаписи.КоличествоОстаток);
...
Функция ПолучитьМассивТоваров(Страница)
	...
	СтрПараметры.Вставить("skus", WarehouseID ); // <== подставить массив баркодов
...
Процедура УстановитьОстатки(МассивТоваров) Экспорт
	...
	Для каждого ТекСтр Из МассивТоваров Цикл
		...
		СтруктураТовара.Вставить("barcode", 	ТекСтр.ID);
		СтруктураТовара.Вставить("stock",		ТекСтр.Остаток);
